...
@Entity
@Table(name = "tbl_bellofarm_total_inoutward")
public class BellOfArmTotalInOutward {
    ...
    public BellOfArmTotalInOutward() {
    }

    public BellOfArmTotalInOutward(Long id, String weaponName, String roundName, Integer totalStock, Integer distributionStock,
                                   Integer availableStock, String expiryDate) {
        this.id = id;
