...
@Entity
@Table(name = "tbl_outward_service_prefix")
public class OutwardServicePrefix {
	...
	public OutwardServicePrefix() {
		super();
	}

	public OutwardServicePrefix(Long id, String prefixName, String status, LocalDateTime createdAt,
