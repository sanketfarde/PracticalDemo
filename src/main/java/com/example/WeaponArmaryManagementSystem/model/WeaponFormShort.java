...
public class WeaponFormShort {
	...
	public Integer getId() {
		...
		public WeaponFormShort(Integer id, String weaponName, String weaponType, String status, String weaponStatus) {
			this.id = id;
			this.weaponName = weaponName;
			this.weaponType = weaponType;
			this.status = status;
