...
@Entity
@Table(name = "tbl_workshop_inoutward")
public class WorkshopInOutward {
    ...
    public WorkshopInOutward() {
    }

    public WorkshopInOutward(Long id, String date, String buttNo, String weaponName, String roundName, String inwardNo, String outwardNo, String weaponType, String manufacturerName, String manufacturerNo, String referenceNo, String kitCommitteeNo, String caratNo, String boxNo, String lotNo, String totalQuantity, String balancedQuantity, String recievedQuantity,
                             String expiryDate, String recievedBy, String remark, String employeeId, String employeeName, String employeeDesignation, String employeePostingDate, String status, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.date = date;
        this.buttNo = buttNo;
